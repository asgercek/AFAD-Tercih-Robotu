...
Aday ekleme formu (isim, puan, 15 tercih)
Tercih listelerini kadro verisinden otomatik doldurma
Puan bazlı sıralama ve ilk uygun tercihe yerleştirme algoritması
Responsive ve erişilebilir tasarım
Sonuçları tablo halinde gösterme ve JSON/CSV indirme
